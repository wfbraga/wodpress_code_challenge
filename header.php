...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="<?php echo get_template_directory_uri() ?>image/x-icon" href="<?php echo get_template_directory_uri() ?>/assets/img/favicon.ico" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Desafio 21 Dias</a>
